...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./posts/benefits-of-document-digitization.md": () => import('../chunks/benefits-of-document-digitization_YXVpepa9.mjs').then(n => n._),"./posts/government-archive-digitization-checklist.md": () => import('../chunks/government-archive-digitization-checklist_BNKLGur6.mjs').then(n => n._),"./posts/how-to-estimate-digitization-costs.md": () => import('../chunks/how-to-estimate-digitization-costs_B8SjCHSk.mjs').then(n => n._),"./posts/medical-record-digitization-guide.md": () => import('../chunks/medical-record-digitization-guide_Cf2UqlYc.mjs').then(n => n._),"./posts/secure-document-scanning-for-banks.md": () => import('../chunks/secure-document-scanning-for-banks_K1FNAG6d.mjs').then(n => n._)}), () => "./posts/*.md");
